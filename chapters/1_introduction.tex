...
% จุดประสงค์ เพื่อศึกษาส่วนประกอบของภาษาโปรแกรมมิ่งที่รองรับ module system และพัฒนา Module system สำหรับภาษา Jolie

% เกริ่นนำ 1 paragraph
% idea 1 -----------------
% ปัจจุบันภาษาโปรแกรมมิ่งมีหลายรูปแบบของการให้บริการ
% โดยแบ่งออกเป็นระดับ..เพื่อให้รองรับ composing dif serv.
% และ jolie ก็เป็นภาษาหนึ่งที่เกิดมาเพื่อทำ...
% ซึ่งมีลักษณะเป็น SOC ที่จะช่วยให้การดำเนินโปรเจคที่มีลักษณะ...มีความยืดหยุ่น หรือดีขึ้นยังไงบ้าง
% ดังนั้นจึงเป็นที่มาของโปรเจคเล่มนี้ ในการที่จะ ศึกษาส่วนประกอบของภาษาโปรแกรมมิ่งที่รองรับ module system และพัฒนา Module system สำหรับภาษา Jolie
...
% Separating of concern, SOC Module System
