...
A Jolie script is a module that included a service node named \texttt{main}.
...
An embedding mechanism is also extended into a service node. It enables implantation of service orchestration in  
